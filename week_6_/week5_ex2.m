...
[ofdmStream,P,dummy_elements]=ofdm(qam_stream,N,L,on_off_vector,'n',trainblock,Lt,Ld);
...
[rxOfdmStream,h_freq_estimated]=ofdm_demod(out_aligned,N,L,P,dummy_elements,length(trainblock),ones(N,1),on_off_vector,trainMode,trainblock,Lt,Ld);
